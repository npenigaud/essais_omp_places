...
do
  ...
  do
    ...
    \rm -f out.LLOMP=$LLOMP.LLBIND=${LLBIND}_hw1.txt linux_bind.000000.txt
    ...
    ./master.x > out.LLOMP=$LLOMP.LLBIND=${LLBIND}_hw1.txt 2>&1

    cat linux_bind.000000.txt >> out.LLOMP=$LLOMP.LLBIND=${LLBIND}_hw1.txt
